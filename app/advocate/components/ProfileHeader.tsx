...
export default function ProfileHeader({ theme, onToggleTheme, onLogoutClick, advocateName = "Advocate" }: ProfileHeaderProps) {
          ...
          >
            ...
            <div className="text-left hidden sm:block">
              ...
              <div className="text-[10px] font-semibold text-slate-400 dark:text-slate-500 flex items-center gap-0.5">
                <ShieldCheck className="w-3 h-3 text-emerald-500" /> Verified Counsel
              </div>
            </div>
          </button>
